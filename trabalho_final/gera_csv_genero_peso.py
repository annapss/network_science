...
try:
    ...
    # --- 7. Construir Lista de Ocorrências de Coautoria ---
    ...
    arestas = [] # Lista para salvar (Autor1, Autor2)
    ...
    if not arestas:
        ...
        # Agrupar por Autor1 e Autor2, contar o tamanho (size) e resetar o índice
