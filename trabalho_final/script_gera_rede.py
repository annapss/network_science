...
try:
    ...
    if not df_filtrado.empty:
        ...
        print("Atributos de gênero adicionados aos nós.")
    else:
        print("DataFrame filtrado está vazio, sem nós para adicionar.")
    ...
    color_map = []
    # G.nodes(data=True) permite acessar o nó e seus dados (incluindo Gênero)
    ...
    if not G.nodes():
        ...
        print(f"Desenhando o grafo com {G.number_of_nodes()} nós... (Isso pode ser MUITO lento)")
